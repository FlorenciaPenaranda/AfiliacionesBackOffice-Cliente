    ...
    render() {
        return html`
            ...
            <div id="opciones" class="grid column" @click=${this.toggleMenu}>
                ...
                <button link ?selected="${this.selectedOption[1]}" @click=${this.auditoriaAfiliaciones} .option=${"auditoriaAfiliaciones"} solo-logueado>Auditoria Afiliaciones</button>
